...
public class Root_Navigation extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener{
    ...
    private Location originLocation; //Initializing OriginLocation
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strtNavigation.setOnClickListener(v -> {
            NavigationLauncherOptions options = NavigationLauncherOptions.builder()
                    ...
                    .build();
            NavigationLauncher.startNavigation(Root_Navigation.this, options);
        });
    }
    ...
    {
        mapbox.addMarker(new MarkerOptions().setPosition(new LatLng(45.6407,-63.5783)));
    }
    ...
    private void getRoute(){
        NavigationRoute.builder(this)
                ...
                .destination(Point.fromLngLat(-63.5783,45.6407))
                .build()
                .getRoute(new Callback<DirectionsResponse>() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        ...
                        {
                            Toast.makeText(Root_Navigation.this,"No route found",Toast.LENGTH_LONG).show();
                        }
                        Route = response.body().routes().get(0);
                        navigationMapRoute = new NavigationMapRoute(null, mapView, mapbox, R.style.NavigationMapRoute);
                        navigationMapRoute.addRoute(Route);
                        mapbox.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(originLocation.getLatitude(),originLocation.getLongitude()),9));
                    }
